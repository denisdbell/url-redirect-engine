...
class RedirectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create redirect" do
    assert_difference('Redirect.count') do
      post redirects_url, params: { redirect: { new_url: @redirect.new_url, rule: @redirect.rule } }
    end
  ...
  test "should update redirect" do
    patch redirect_url(@redirect), params: { redirect: { new_url: @redirect.new_url, rule: @redirect.rule } }
